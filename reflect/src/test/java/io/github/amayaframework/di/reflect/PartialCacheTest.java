...
public final class PartialCacheTest {
    ...
    public void testEmptyService() {
        ...
        var eF = factory.create(Util.EMPTY_SCHEMA, CacheMode.PARTIAL);
    ...
    public void testNestedService() {
        ...
        s1F.set(String.class, v -> "str1");
        repo.put(Service1.class, s1F);
        repo.put(Service3.class, factory.create(Util.S3_SCHEMA, CacheMode.PARTIAL));
    ...
    public void testComplexService() {
        ...
        repo.put(Service1.class, s1F);
        repo.put(Service3.class, s3F);
        repo.put(App.class, appF);
